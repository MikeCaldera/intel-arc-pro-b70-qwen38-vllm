...
| Qwen3.8 champion `f01e24f6` (optional MTP speed) | 4 | `patches/patch_draft_lmhead_int4.py` then `patch_draft_mtp_int4.py` | Draft-side INT4 RTN (S+M1). Env off unless set. Same-image n=5: p512/g128 112.65 vs 81.20 (+38.7%), p8192/g128 103.63 vs 77.52 (+33.7%), short agentic +32.8%. Speed only; accept 95.9%→94.4%. |

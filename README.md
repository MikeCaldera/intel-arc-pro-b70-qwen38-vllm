...
3. **[Qwen3.8-27B (Dense MoE/Hybrid)](docs/qwen38-27/QWEN38-VLLM-XPU.md):** 100K context, optional draft-INT4 overlay, concurrent serving via mixed-split v5. [Windows 11 Guide](docs/qwen38-27/WINDOWS-STANDALONE.md).

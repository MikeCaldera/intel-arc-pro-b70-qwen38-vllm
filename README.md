...
| **Qwen3.8-27B** | vLLM XPU (nightly digest) | Dense GPTQ-INT4 + MTP4; optional draft-INT4; concurrent serving via mixed-split v5 | BF16 draft MTP4 p512/g128 **83.7** n=5 (LMX `cmsur82fz06svms01ga1f0z83`). Optional draft-INT4: **112.65** n=5 cache-off (LMX `cmszpqy000e8fms014ty6i5x3`), **100.2** current stack prefix-on (LMX `cmt01ygp40eg9ms016odaz6kc`). Concurrent (v5 + draft-INT4, prefix on): **C5 realistic 138.3** Σ-streams (27.7/user, 60/60 OK; LMX `cmt023kzf0egfms01rxx5jhv7`), **C5 short-prompt 203.8 / C32 224.2** (lmx harness), C32 Σ-streams 903; 0 crashes incl. mixed long-prefill | [QWEN38-VLLM-XPU](docs/qwen38-27/QWEN38-VLLM-XPU.md) |

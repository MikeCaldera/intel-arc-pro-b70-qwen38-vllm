...
| Qwen3.8-Flash-Next fused-FP32 C1 decode | 2× Intel Arc Pro B70 | llama.cpp | P512 / G128 / C1 · n=5 median | 23.38 token/s (engine predicted output tps) · 23.73 token/s (engine predicted output tps max) · 183.98 token/s (engine prompt tps) | [Official lab](https://github.com/SergiioB/intel-arc-pro-b70-inference-cookbook/blob/f78a8893794692b703b07b9e016b31c9784345e6/results/qwen38-flash-next-dual-b70-c1/n5-fused-fp32-c8k-p512-g128/summary.json) |
| Qwen3.8-Flash-Next fused-F16 C1 cold input | 2× Intel Arc Pro B70 | llama.cpp | P9096 / G128 / C1 · n=5 median | 594.49 token/s (engine prompt tps) · 20.34 token/s (engine predicted output tps) | [Official lab](https://github.com/SergiioB/intel-arc-pro-b70-inference-cookbook/blob/f78a8893794692b703b07b9e016b31c9784345e6/results/qwen38-flash-next-dual-b70-c1/n5-fused-f16-c16k-p9096-g128/summary.json) |
...
| Qwen3.8-Flash-Next 128K C1 capacity | 2× Intel Arc Pro B70 | Provisional | C1 llama.cpp SYCL completed p512/g128 and actual-p9096/g128 at -c 131072 -b/-ub 1024 (b1536+ rejected). n=3 only. p512 decode ~23.06-23.54 engine tok/s. c128 is context, not concurrency. Not a ranking cell. | [source](https://github.com/SergiioB/intel-arc-pro-b70-inference-cookbook/blob/f78a8893794692b703b07b9e016b31c9784345e6/results/qwen38-flash-next-dual-b70-c1/n3-context-map.json) |
| Qwen3.8-Flash-Next GPU MUL_MAT_ID grouping | 2× Intel Arc Pro B70 | Provisional | Matched C1 n=3 fused-F16 16K actual-p9096: GPU grouping 599.48 vs disable 594.67 cold-input (+0.81%). Decode unchanged. Occupancy D2H remains. Not a ranking cell. | [source](https://github.com/SergiioB/intel-arc-pro-b70-inference-cookbook/blob/f78a8893794692b703b07b9e016b31c9784345e6/results/qwen38-flash-next-dual-b70-c1/n3-f16-gpu-group-c16k-p9096-g128/summary.json) |

...
| Qwen3.8-27B | `…f01e24f6c7ff…` | `patch_mtp_nightly.py` then `patch_mtp_boundary.py`; optional Cn: `patch_gdn_split_mixed.py` (v5 compact+scatter) | original full-buffer `patch_gdn_split_mixed` (OOB on 0.1.12.3) |
